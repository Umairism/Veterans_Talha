...
INSERT INTO profiles (
  ...
  'Served 20 years in the military. Now dedicated to community service and mentoring youth.',
  'New York',
  15000,
  'Bronze Veteran',
  NOW()
...
INSERT INTO profiles (
  ...
  'org@test.com',
  'Community Foundation NYC',
  'Leading NGO focused on community development and social welfare programs.',
  'New York',
  0,
  NOW()
) ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO profiles (
  ...
  'Former high school principal with 30 years of experience in education.',
  'Los Angeles',
  27000,
  'Silver Veteran',
  NOW()
...
INSERT INTO profiles (
  ...
  'Former aerospace engineer passionate about environmental conservation.',
  'San Francisco',
  42000,
  'Ruby Veteran',
  NOW()
...
SELECT 'Test accounts created successfully!' as message,
       'Veteran: veteran@test.com (any password)' as account_1,
       'Organization: org@test.com (any password)' as account_2,
       'Veteran: sarah@test.com (any password)' as account_3,
       'Veteran: michael@test.com (any password)' as account_4;
